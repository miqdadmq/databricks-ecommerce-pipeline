...
# MAGIC Ingest synthetic e-commerce data and store as Delta table (raw, unmodified).
...
# MAGIC %md
# MAGIC ## Generate synthetic e-commerce data
...
# MAGIC Store raw data as-is — no transformations at this layer.
